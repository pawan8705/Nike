const Description = () => {
  return (
    <div className='px-6 md:px-0'>
      <div className='flex'>
        <div className='border border-gray-400 font-semibold p-4 dark:text-[#9dffe8]'>Description</div>
        <div className='border border-gray-400 font-semibold p-4 dark:text-[#9dffe8]'>Reviews (122)</div>
      </div>
      <div className='border border-gray-400 p-8 dark:text-[#9dffe8]'>
