...
const Cart = () => {
  ...
  return (
    <div className='dark:bg-[#00042b] bg-white'>
      <div className='max-w-7xl mx-auto my-10 p-4 dark:bg-[#00042b]'>
        {getTotalCartItems() === 0 ? <div className='flex items-center justify-center'><img src={EmptyCart} alt='' /></div> : <div>
          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-[0.5fr,2fr,1fr,1fr,1fr,1fr] items-center px-4 dark:text-white'>
            <p>Products</p>
            <p>Title</p>
          ...
          <div className='flex flex-col lg:flex-row my-12 gap-10 md:gap-32'>
            <div className='flex-1 flex flex-col gap-4 dark:text-white'>
